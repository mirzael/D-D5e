    ...
    EncounterComponent.prototype.generateEncounter = function () {
        ...
        if (this.players.length <= 0) {
            ...
            if (this.difficultyLevel === encounterConstants_1.Difficulty.Deadly)
                crMult_1 = 1.5;
            var filteredMonsters = this.monsters.filter(function (monster) { return monster.CR * crMult_1 <= maxCr && (_this.typeFilter === "none" || monster.Type.indexOf(_this.typeFilter) > -1); });
